...
The $10B document-training speed comparison is recorded in `artifacts/multirate_recovery/10B/speed_benchmark/comparison.json` and documented in `docs/multirate-expanded-coverage.md`: identical checkpoint/batches, exact loss and model-state equality, and per-stage profiling.
