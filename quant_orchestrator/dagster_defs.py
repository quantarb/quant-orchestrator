...
ML_TRADING_EXPERIMENT_CONFIG_SCHEMA = {
    ...
    "oos_start": str,
    "score_start": str,
    "fit_all_available_data": Field(bool, default_value=False),
    "refresh_missing_fmp_data": Field(bool, default_value=False),
    "refresh_missing_fmp_include_prices": Field(bool, default_value=True),
    "refresh_missing_fmp_force_macro": Field(bool, default_value=False),
    "refresh_missing_fmp_staleness_days": Field(int, default_value=90),
    "refresh_missing_fmp_skip_recent_hours": Field(float, default_value=24.0),
    "refresh_missing_fmp_max_workers": Field(int, default_value=8),
    "top_k_values": str,
...
def run_ml_trading_experiment_scheduled(context) -> str:
    ...
    experiment_config = MLTradingExperimentConfig(
        ...
        fit_all_available_data=bool(config["fit_all_available_data"]),
        refresh_missing_fmp_data=bool(config["refresh_missing_fmp_data"]),
        refresh_missing_fmp_include_prices=bool(config["refresh_missing_fmp_include_prices"]),
        refresh_missing_fmp_force_macro=bool(config["refresh_missing_fmp_force_macro"]),
        refresh_missing_fmp_staleness_days=int(config["refresh_missing_fmp_staleness_days"]),
        refresh_missing_fmp_skip_recent_hours=float(config["refresh_missing_fmp_skip_recent_hours"]),
        refresh_missing_fmp_max_workers=int(config["refresh_missing_fmp_max_workers"]),
