            ...
            [
                {
                    ...
                    "equity_entry_notional": _finite_float(trade.get("equity_entry_notional")),
                    "equity_entry_fee": _finite_float(trade.get("equity_entry_fee")),
                    "equity_entry_shares": _finite_float(trade.get("equity_entry_shares")),
                    "equity_exit_notional": _finite_float(trade.get("equity_exit_notional")),
                    "equity_exit_fee": _finite_float(trade.get("equity_exit_fee")),
