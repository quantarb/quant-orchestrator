...
class OptionFamilyRankerConfig:
    option_panel: str | Path = DEFAULT_OPTION_PANEL
    symbols: tuple[str, ...] = ()
    feature_families: tuple[str, ...] = ()
    all_feature_families: bool = False
...
@dataclass(frozen=True)
class OptionFamilyRankerResult:
...
def run_option_family_ranker_experiment(config: OptionFamilyRankerConfig) -> OptionFamilyRankerResult:
    args = SimpleNamespace(
        option_panel=str(config.option_panel),
        symbols=",".join(config.symbols),
        feature_family=list(config.feature_families) or None,
        all_feature_families=bool(config.all_feature_families),
...
def main() -> None:
    ...
    config = OptionFamilyRankerConfig(
        ...
        feature_families=tuple(args.feature_family or ()),
        all_feature_families=bool(args.all_feature_families),
...
def _run_option_family_ranker_args(args: SimpleNamespace, *, config: OptionFamilyRankerConfig) -> OptionFamilyRankerResult:
